      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center">
          ...
          <div className="relative z-10 text-center text-white px-6">
            <p className="luxury-subheading text-white/80 mb-4">Private Estates</p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold luxury-heading">
              Our Villas
            </h1>
            <p className="mt-6 text-lg text-white/90 max-w-2xl mx-auto">
              Discover spacious private estates with stunning pools, gardens, 
              and breathtaking views of the Atlas Mountains.
            </p>
          </div>
        </section>
