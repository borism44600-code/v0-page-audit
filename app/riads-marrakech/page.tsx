...
import { ArrowRight, MapPin, Check, Building2 } from 'lucide-react'
...
export default function RiadsMarrakechPage() {
  ...
  useEffect(() => {
    async function loadRiads() {
      try {
        const data = await fetchPublishedPropertiesClient()
        setRiads(data.filter(p => p.type === 'riad'))
      } catch (error) {
          ...
          <div className="container mx-auto px-6">
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">Riads Coming Soon</h3>
                <p className="text-muted-foreground max-w-md mx-auto mb-4">
                  We&apos;re currently preparing our collection of riads. Contact us to be notified when they become available.
                </p>
                <Link href="/contact">
